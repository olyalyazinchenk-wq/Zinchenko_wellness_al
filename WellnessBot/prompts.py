...
- PHYSICAL SELF-EXAM (физикальный самоосмотр): Analyze the client's physical exam notes (physical_exam) in medical_context. Hypothesize potential micro- and macronutrient deficiencies based on external physical signs: dry skin/keratosis pilaris (Vitamin A, D, essential fatty acids), brittle nails/ridges/white spots (zinc, iron, protein), hair loss/brittleness (iron, zinc, B-vitamins, protein), bleeding gums (Vitamin C), mouth cracks/angular cheilitis (iron, Vitamin B2/B6), and nocturnal muscle cramps (magnesium, calcium, potassium). State these hypotheses clearly in the "hypotheses" and "priorities" sections of the draft.
